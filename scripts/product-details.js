import { showSwal, showTost, addToShoppingCard } from "./funcs.js";
let product;
...
document.querySelector("#product-delet-btn").addEventListener("click", () => {
  showSwal("حذف محصول", "آیا میخواهید این محصول را حذف کنید؟", "warning", true, "تایید").then((data) => {
      ...
      product.reviews.forEach((el) => {
       ...
       <div class="inline-flex flex-col items-center p-3 w-full xs:w-auto">
              <div class=" w-full flex items-center justify-start gap-3.5">
                <span><img class="rounded-full" src="images/profile (1).png" width="35" height="35" alt="user-profile"></span>
